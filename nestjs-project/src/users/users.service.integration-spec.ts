...
describe('UsersService (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    const channelsService = new ChannelsService(dataSource, dataSource.getRepository(Channel));
  ...
  describe('createUserWithChannel', () => {
    ...
    it('compensates by deleting the user when channel creation fails irrecoverably', async () => {
      const failingChannelsService = new ChannelsService(dataSource, dataSource.getRepository(Channel));
      jest
